/**
 * Renders the cinematic anime-inspired Kamehameha sequence used in the webview.
 * The character illustration is bundled with the extension; the effects remain
 * procedural so they scale cleanly across editor sizes.
 */
export function getAnimationHtml(
  duration: number,
